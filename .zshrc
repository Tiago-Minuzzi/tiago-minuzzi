...
alias fpls="flatpak list --columns=name,application"
alias fpup="flatpak update -y"
alias fpuu="flatpak uninstall --unused"
alias gta="git add"
...
alias view="nvim -M"
alias vpn="sudo openfortivpn -c .config/openfortivpn/config --saml-login"

...
-- {{{ Main
local theme = {}
theme.wallpaper = "/home/tiago/.config/awesome/themes/catppuccin/wallpaper.png"
-- }}}
...
-- {{{ Misc
theme.awesome_icon           = "/home/tiago/.config/awesome/themes/catppuccin/awesome-icon.png"

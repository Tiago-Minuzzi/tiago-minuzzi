...
# System utilities
sudo apt install gnome-tweak-tool vim vlc buil-essential git ssh openssh-server make flameshot chromium chrome-gnome-shell libappindicator3-1 terminator python3 python3-pip htop firmware-linux-nonfree plymouth plymouth-themes redshift redshift-gtk caffeine -y

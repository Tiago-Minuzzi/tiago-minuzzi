...
tes_mdl = "models_hdf5/gradient_boost_model.pkl"
...
modelo = pickle.load(open(tes_mdl,'rb'))
res_prob=modelo.predict_proba(user_seq_to_pred)
res_label=modelo.predict(user_seq_to_pred)
